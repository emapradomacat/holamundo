pipeline{
    ...
    */
    environment {
        ...
        NEXUS_URL = "192.168.253.128:8081"
    ...
    stages{
        ...
        stage('Download artifact from nexus'){
            ...
            steps{
                sh '''
                    pwd 
                    curl -v -u admin:admin -o app.jar http://192.168.253.128:8081/repository/maven-public/org/springframework/jb-hello-world-maven/0.2.1/jb-hello-world-maven-0.2.1.jar
                '''
            }
        }
        ...
        stage('Deploy container'){
            ...
            steps{
                sh '''
                    docker run --name holamundo -p 9000:80 holamundo
                '''
